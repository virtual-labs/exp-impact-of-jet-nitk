        ...
        if (resultCount == 1) {
          ...
          if (flag == 1) {
            document.getElementById("v7-6").innerHTML =
              "Theoretical force, F<sub>th</sub> = &rho;AV<sup>2</sup> = ";
            idInput = document.getElementById("v7-6");
            userCalculation(idInput, flat[4][lnt], "N");
          }
          if (flag == 2) {
            document.getElementById("v7-6").innerHTML =
              "Theoretical force, F<sub>th</sub> = 2&rho;AV<sup>2</sup> = ";
            idInput = document.getElementById("v7-6");
            userCalculation(idInput, hemi[4][lnt], "N");
          }
          if (flag == 3) {
            document.getElementById("v7-6").innerHTML =
              "Theoretical force, F<sub>th</sub> = &rho;A(Vcos&theta;)<sup>2</sup> =";
            idInput = document.getElementById("v7-6");
...
function magic() {
  if (simsubscreennum == 1) {
    ...
    if (flag == 0) {
      ...
      setTimeout(function () {
        ...
        document.getElementById("arrow1").style =
          "visibility:visible ;position:absolute; left:240px; top: 115px; height: 30px; z-index: 10;";
    ...
    setTimeout(function () {
      ...
      document.getElementById("arrow1").style =
        "visibility:visible ;position:absolute; left:495px; top: 225px; height: 40px; z-index: 10;";
      document.getElementById("arrow1").style.WebkitTransform =
        "rotate(180deg)";
      // Code for IE9
    ...
    setTimeout(function () {
      ...
      document.getElementById("arrow1").style =
        "visibility:visible ;position:absolute; left:25px; top: 180px; height: 30px; z-index: 10;";
      document.getElementById("arrow1").style.WebkitTransform =
        "rotate(180deg)";
      // Code for IE9
      document.getElementById("arrow1").style.msTransform = "rotate(180deg)";
    ...
    setTimeout(function () {
      ...
      document.getElementById("arrow1").style =
        "visibility:visible ;position:absolute; left:90px; top: 320px;; height: 40px; z-index: 10;";
      document.getElementById("arrow1").style.WebkitTransform =
        "rotate(225deg)";
      // Code for IE9
    ...
    setTimeout(function () {
      ...
      document.getElementById("arrow1").style =
        "visibility:visible ;position:absolute; left:366px; top: 422px; height: 30px; z-index: 10;";
      document.getElementById("arrow1").style.WebkitTransform =
        "rotate(270deg)";
      // Code for IE9
      document.getElementById("arrow1").style.msTransform = "rotate(270deg)";
      // Standard syntax
      document.getElementById("arrow1").style.transform = "rotate(270deg)";
      document.getElementById("can6-out").onclick = function () {
        step6();
      };
    }, 1000);
    ...
    if (flag == 1) {
      ...
      document.getElementById("v7-1").innerHTML =
        "Discharge of water, Q = " + flat[2][lnt] + "cm<sup>3</sup>/sec";
      document.getElementById("v7-2").innerHTML =
        "Wieght on the pan, W = " + flat[0][lnt] + "g";
    } else if (flag == 2) {
      ...
      document.getElementById("v7-1").innerHTML =
        "Discharge of water, Q = " + hemi[2][lnt] + "cm<sup>3</sup>/sec";
      document.getElementById("v7-2").innerHTML =
        "Wieght on the pan, W = " + hemi[0][lnt] + "g";
    } else if (flag == 3) {
      ...
      document.getElementById("v7-1").innerHTML =
        "Discharge of water, Q = " + inclined[2][lnt] + "cm<sup>3</sup>/sec";
      document.getElementById("v7-2").innerHTML =
        "Wieght on the pan, W = " + inclined[0][lnt] + "g";
    }
    ...
    document.getElementById("nextButton").style.visibility = "hidden";
    document.getElementById("step8text1").onclick = function () {
      step8();
    };
  }
}
...
function fvane() {
  ...
  document.getElementById("vane4").innerHTML =
    "Selected vane type : <b>Flat Vane</b>";
  document.getElementById("nextButton").style.visibility = "visible";
}
...
function hvane() {
  ...
  document.getElementById("vane3").style.color = "#000000";
  document.getElementById("vane4").innerHTML =
    "Selected vane type : <b>Hemi spherical  Vane</b>";
  document.getElementById("nextButton").style.visibility = "visible";
}
...
function ivane() {
  ...
  document.getElementById("vane4").innerHTML =
    "Selected vane type : <b>Inclined Vane</b>";
  document.getElementById("nextButton").style.visibility = "visible";
}
...
function step2() {
  ...
  setTimeout(function () {
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left:414.5px; top: 110px;  height: 30px; z-index: 10;";
...
function step21() {
  ...
  setTimeout(function () {
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left:520px; top:155px; height: 30px; z-index: 10;";
  ...
  setTimeout(function () {
    ...
    if (flag == 1) {
      document.getElementById("v4-1").innerHTML =
        "Put " + flat[0][lnt] + "gm weight on the pan";
    } else if (flag == 2) {
      document.getElementById("v4-1").innerHTML =
        "Put " + hemi[0][lnt] + "gm weight on the pan";
    } else if (flag == 3) {
      document.getElementById("v4-1").innerHTML =
        "Put " + inclined[0][lnt] + "gm weight on the pan";
    }
  }, 500);
  setTimeout(function () {
    myInt = setInterval(function () {
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left:590px; top: 415px; height: 30px; z-index: 10;";
    document.getElementById("arrow1").style.WebkitTransform = "rotate(270deg)";
    // Code for IE9
    document.getElementById("arrow1").style.msTransform = "rotate(270deg)";
    // Standard syntax
    document.getElementById("arrow1").style.transform = "rotate(270deg)";
    document.getElementById("can4-10").onclick = function () {
      step4();
    };
  }, 1000);
}
...
function step5() {
  ...
  document.getElementById("arrow1").style =
    "visibility:visible ;position:absolute; left: 635px; top: 250px; height: 50px; z-index: 10;";
  ...
  document.getElementById("can5-7").onclick = function () {
    step51();
  };
}
...
function step51() {
  ...
  setTimeout(function () {
    ...
    document.getElementById("arrow1").style =
      "visibility:visible ;position:absolute; left:255px; top: 120px; height: 30px; z-index: 10;";
    document.getElementById("arrow1").style.WebkitTransform = "rotate(270deg)";
    // Code for IE9
    document.getElementById("arrow1").style.msTransform = "rotate(270deg)";
    // Standard syntax
...
function step52() {
  ...
  document.getElementById("arrow1").style =
    "visibility:visible ;position:absolute; left:560px; top: 110px;  height: 30px; z-index: 10;";
  document.getElementById("arrow1").style.WebkitTransform = "rotate(270deg)";
  // Code for IE9
  document.getElementById("arrow1").style.msTransform = "rotate(270deg)";
  // Standard syntax
  ...
  document.getElementById("can5-12").onclick = function () {
    step53();
  };
}
function step53() {
  ...
  setTimeout(function () {
    ...
    if (flag == 1) {
      document.getElementById("v6-1").innerHTML =
        "Time taken by water to fill 5cm height, t=" + flat[1][lnt] + "sec";
      setTimeout(function () {
      ...
      document.getElementById("v6-1").innerHTML =
        "Time taken by water to fill 5cm height, t=" + hemi[1][lnt] + "sec";
      setTimeout(function () {
        document.getElementById("v6-2").style.visibility = "visible";
        document.getElementById("v6-2").innerHTML = "Discharge, Q = ";
        idInput = document.getElementById("v6-2");
      ...
      document.getElementById("v6-1").innerHTML =
        "Time taken by water to fill 5cm height, t=" + inclined[1][lnt] + "sec";
      setTimeout(function () {
        document.getElementById("v6-2").style.visibility = "visible";
        document.getElementById("v6-2").innerHTML = "Discharge, Q = ";
        idInput = document.getElementById("v6-2");
